...
<body>
    ...
    <form action="consulta.php" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="form-field">
                    ...
                    <select name="status" id="status">
                        ...
                        <option value="2">Não confirmada</option>
                    </select>
                </div>
            </div>
            ...
            <div class="button-group">
                <button type="submit" name="acao" value="salvar">Agendar Consulta</button>
                <a href="lista_consulta.php" style="padding:10px 16px;border-radius:6px;background:#bdc3c7;color:#000;text-decoration:none;font-weight:bold;">Ver Consultas</a>
            </div>
